...
from .indexer import add_provenance, db_connect, upsert_document, upsert_entity
...
def crawl_url(self, url: str):
    ...
    with db_connect() as conn:
        ...
        # Co-occurring entities become weighted document-scoped graph edges.
